...
def get_training_parser(default_task='translation'):
    ...
    add_generation_args(parser) ## add online bleu computation
    return parser
...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--float-valid', default=False, action='store_true',
                        help='if true, use float type for valid step')
...
def add_common_eval_args(group):
    ...
    group.add_argument('--model-overrides', default={}, nargs='+', action=StoreDictKeyPair, metavar='DICT',
                       help='a dictionary used to override model args at generation '
                            'that were used during model training')
...
def add_generation_args(parser):
    ...
    group.add_argument('--covpen', default=0, type=float,
    ...
    #### add decoding path
    group.add_argument('--decoding-path', default=None, type=str,
                       help='output decoding files')
    group.add_argument('--valid-decoding-path', default=None, type=str,
                       help='output validation decoding files')
    group.add_argument('--multi-bleu-path', default='./', type=str,
                       help='multi bleu path')
